		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>请输入查询ID</h4>
				<form action="use/search.action" method="post">
				<input type="text" id="ID" name="ID" placeholder="请输入ID" value=${myuse.ID }>
				<span>
				<input type="submit" value="查询" />
				</span>
				</form>
				<form action="use/reset.action" method="post">
				<input type="submit" value="重置" />
				</form>
									<h3>图片展示</h3>
				<img src="${myuse.picture_url }" alt="" id="pic" name="pic" height="300" width="450"><br/><br/>
				</div>
				<h4>饮片使用信息</h4>
				<div class="col-md-6 skills-w3right bar_group"> 
				<label>公司：</label>
				<input type="text" id="Company" name="Company" style="border:0px" readonly value=${myuse.company }><br/><br/>
				<label>药店进货账目：</label>
				<input type="text" id="Pharmacy_Ledger" name="Pharmacy_Ledger" style="border:0px" readonly value=${myuse.pharmacy_Ledger }><br/><br/>
				<label>消费者交易凭证：</label>
				<input type="text" id="Consumer_Ledger" name="Consumer_Ledger" style="border:0px" readonly value=${myuse.consumer_Ledger }><br/><br/>
