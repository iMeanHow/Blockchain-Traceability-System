...
<script type="text/javascript">
            ...
            function AutoRun(){
            	...
            	var t="<%=session.getAttribute("username")%>"; 
            	if(t=="null"||t=="")
            		{
            		alert("请先登录!");
            	...
            	var abc = document.getElementById("left");
            	var efg=document.getElementById("total");
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/"+table+"/progress.action",
                    dataType:"json",
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/"+table+"/total.action",
                    dataType:"json",
                    success : function(data) {
                    	$("#total").empty();	
                        total = data;
                        efg.value=total;
            			progressBar.style.width = Math.round((total-num_left)/ total * 100) + "%";
            			percentageDiv.innerHTML = Math.round((total-num_left)/ total * 100) + "%";
...
<div class="skills w3-agileits w3-services-page">
		<div class="container"> 
			<div class="skills-agileinfo">
				...
				<label>剩余条数：</label>
				<input type="text" id="left" name="left" readonly><br/><br/>
				<br/>
				<label>上传进度</label>
