	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>饮片生产信息插入</font></li>
...
<div class="skills w3-agileits w3-services-page">
		<div class="container"> 
			<div class="skills-agileinfo">
				...
				<center>
					<h4>请输入增添信息</h4>		
				<form action="drinks_Production/insert.action" id="uploadForm" method="post">
				...
				<label>GMP证书：</label>
				<input type="text" id="GMP_Certificate" name="GMP_Certificate" ><br/>
				<label>不合格解除交易：</label>
				<input type="text" id="Auto_Cancelation" name="Auto_Cancelation" ><br/>
				<label>检测报告：</label>
				<input type="text" id="Test_Report" name="Test_Report" ><br/>
				<label>药材品种：</label>
				<input type="text" id="Variety" name="Variety" ><br/>
				<label>入库时间：</label>
				<input type="text" id="Storage_Time" name="Storage_Time" ><br/>
				<label>入库批次：</label>
				<input type="text" id="Storage_Batch" name="Storage_Batch" ><br/>	
				<label>入库数量：</label>
				<input type="text" id="Storage_Quantity" name="Storage_Quantity" ><br/>	
				<label>入库等级：</label>
				<input type="text" id="Classification" name="Classification" ><br/>	
				<label>药材来源：</label>
				<input type="text" id="Source" name="Source" ><br/>	
				<label>库房温度：</label>
				<input type="text" id="Storage_Temp" name="Storage_Temp" ><br/>	
				<label>库房湿度：</label>
				<input type="text" id="Storage_Humidity" name="Storage_Humidity" ><br/>	
				<label>加工方法：</label>
				<input type="text" id="Process_Method" name="Process_Method" ><br/>	
				<label>包装批次：</label>
				<input type="text" id="Packing_Batch" name="Packing_Batch" ><br/>
				<label>包装等级：</label>
				<input type="text" id="Packing_Class" name="Packing_Class" ><br/>	
				<label>包装批量：</label>
				<input type="text" id="Packing_Quantity" name="Packing_Quantity" ><br/>	
				<label>交易信息记录：</label>
				<input type="text" id="Deal_Info" name="Deal_Info" ><br/>	
				<label>出库品种：</label>
				<input type="text" id="Output_Variety" name="Output_Variety" ><br/>	
				<label>出库时间：</label>
				<input type="text" id="Output_Time" name="Output_Time" ><br/>	
				<label>出库批次：</label>
				<input type="text" id="Output_Batch" name="Output_Batch" ><br/>	
				<label>出库数量：</label>
				<input type="text" id="Output_Quantity" name="Output_Quantity" ><br/>
				<label>出库去向：</label>
				<input type="text" id="Output_Flow" name="Output_Flow" ><br/>	
				<label>库房温度：</label>
				<input type="text" id="Output_Temp" name="Output_Temp" ><br/>	
				<label>库房湿度：</label>
				<input type="text" id="Output_Humidity" name="Output_Humidity" ><br/><br/>
				<label>公司图片上传</label>
				...
				<input type="hidden" name="Picture_url1" id="Picture_url1">
				<img src="" alt="" id="Show" >
				...
				<a href="Drinks_Production_upload.jsp">批量上传</a>
				</center>
				<div class="clearfix"> </div>
			</div>
		</div>
