		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>请输入查询ID</h4>
				<form action="market/search.action" method="post">
				<input type="text" id="ID" name="ID" placeholder="请输入ID" value=${mymarket.ID }>
				<span>
				<input type="submit" value="查询" />
				</span>
				</form>
				<form action="market/reset.action" method="post">
				<input type="submit" value="重置" />
				</form>
				<h3>公司图片展示</h3>
				<img src="${mymarket.picture_url }" alt="" id="pic" name="pic" height="300" width="450"><br/><br/> 
				<h3>产品图片展示</h3>
				<img src="${mymarket.picture_url1 }" alt="" id="pic1" name="pic1" height="300" width="450"><br/><br/> 
				</div>
				<h4>中药材专业市场信息</h4>
				...
				<label>流向：</label>
				<input type="text" id="Dealing_Flow" name="Dealing_Flow" style="border:0px" readonly value=${mymarket.dealing_Flow }><br/><br/><br/>
