...
<script type="text/javascript">
	function UpladFile() {
		...
		var FileController = "${pageContext.request.contextPath}/planting/UpImg.action"; // 接收上传文件的后台地址 
		// FormData 对象
	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>中药种植信息修改</font></li>
		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>请输入查询ID</h4>
				<form action="planting/usearch.action" method="post">
				<input type="text" id="ID" name="ID" placeholder="请输入ID" value=${myplantingu.ID }>
				<span>
				<input type="submit" value="查询" />
				</span>
				</form>
				<h3>种植图片展示</h3>
				<img src="${myplantingu.picture_url }" alt="" id="pic" name="pic" height="300" width="450"><br/><br/> 
								<h3>药材图片展示</h3>
				<img src="${myplantingu.picture_url }" alt="" id="pic1" name="pic1" height="300" width="450"><br/><br/> 
				</div>
				<h4>中药种植信息</h4>
				<div class="col-md-6 skills-w3right bar_group"> 
				<form action="planting/insert.action" method="post" id="uploadForm">
				<input type="hidden" id="ID" name="ID"  value=${myplantingu.ID }>
				<label>公司：</label>
				<input type="text" id="Company" name="Company"  value=${myplantingu.company }><br/>
				<label>营业执照：</label>
				<input type="text" id="Business_License" name="Business_License"  value=${myplantingu.business_License }><br/>
				<label>联系方式：</label>
				<input type="text" id="Contract" name="Contract"  value=${myplantingu.contract }><br/>
				<label>承诺书：</label>
				<input type="text" id="Commitment" name="Commitment"  value=${myplantingu.commitment }><br/>
				<label>种植品种：</label>
				<input type="text" id="Plant_Type" name="Plant_Type"  value=${myplantingu.plant_Type }><br/>
				<label>种植时间：</label>
				<input type="text" id="Plant_Time" name="Plant_Time"  value=${myplantingu.plant_Time }><br/>
				<label>种植面积：</label>
				<input type="text" id="Plant_Area" name="Plant_Area"  value=${myplantingu.plant_Area }><br/>
				<label>收货重量：</label>
				<input type="text" id="Harvest_Weight" name="Harvest_Weight"  value=${myplantingu.harvest_Weight }><br/>
				<label>预计产量：</label>
				<input type="text" id="Plan_Production" name="Plan_Production"  value=${myplantingu.plan_Production }><br/>
				<label>实际产量：</label>
				<input type="text" id="Real_Production" name="Real_Production"  value=${myplantingu.real_Production }><br/>
				<label>收货时间：</label>
				<input type="text" id="Harvest_Time" name="Harvest_Time"  value=${myplantingu.harvest_Time }><br/>
				<label>含量测定：</label>
				<input type="text" id="Pesticide_Remain" name="Pesticide_Remain"  value=${myplantingu.pesticide_Remain }><br/>
				<label>质检报告：</label>
				<input type="text" id="Test_Report" name="Test_Report"  value=${myplantingu.test_Report }><br/>	
				<label>产地证明：</label>
				<input type="text" id="Origin_Certificate" name="Origin_Certificate"  value=${myplantingu.origin_Certificate }><br/>
				<label>交易凭证：</label>
				<input type="text" id="Transaction_Voucher" name="Transaction_Voucher"  value=${myplantingu.transaction_Voucher }><br/>
				<label>交易数量：</label>
				<input type="text" id="Deal_Quantity" name="Deal_Quantity"  value=${myplantingu.deal_Quantity }><br/>
				<label>交易时间：</label>
				<input type="text" id="Deal_Time" name="Deal_Time"  value=${myplantingu.deal_Time }><br/><br/><br/>
				<label>交易品种：</label>
				<input type="text" id="Deal_Variety" name="Deal_Variety"  value=${myplantingu.deal_Variety }><br/><br/><br/>
				<label>交易价格：</label>
				<input type="text" id="Deal_Price" name="Deal_Price"  value=${myplantingu.deal_Price }><br/><br/><br/>
				<label>交易流向：</label>
				<input type="text" id="Counterparty" name="Counterparty"  value=${myplantingu.counterparty }><br/>				
				种植图片上传（若已有图片则覆盖原图）
				...
				<input type="hidden" name="Picture_url" id="Picture_url" value=${myplantingu.picture_url }>
				<input type="hidden" name="Picture_url1" id="Picture_url1" value=${myplantingu.picture_url1 }>
				<br/>						
