...
<script type="text/javascript">
function UpladFile() {
	var fileObj = document.getElementById("file").files[21]; // js 获取文件对象
...
function UploadFile() {
	var fileObj = document.getElementById("file1").files[21]; // js 获取文件对象
	var FileController = "${pageContext.request.contextPath}/planting/UpImg.action"; // 接收上传文件的后台地址 
	// FormData 对象
	var form = new FormData($("#uploadForm")[0]);//创建一个form对象
	// XMLHttpRequest 对象
	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>中药种植信息插入</font></li>
...
<div class="skills w3-agileits w3-services-page">
		<div class="container"> 
			<div class="skills-agileinfo">
				...
				<center>
				<h4>请输入增添信息</h4>		
				<form action="planting/insert.action" id="uploadForm" method="post">
				<label>ID：</label>
				...
				<label>种植品种：</label>
				<input type="text" id="Plant_Type" name="Plant_Type"  ><br/>
				<label>种植时间：</label>
				<input type="text" id="Plant_Time" name="Plant_Time" ><br/>
				<label>种植面积：</label>
				<input type="text" id="Plant_Area" name="Plant_Area"  ><br/>
				<label>收货重量：</label>
				<input type="text" id="Harvest_Weight" name="Harvest_Weight"  ><br/>
				<label>预计产量：</label>
				<input type="text" id="Plan_Production" name="Plan_Production"  ><br/>
				<label>实际产量：</label>
				<input type="text" id="Real_Production" name="Real_Production" ><br/>
				<label>收货时间：</label>
				<input type="text" id="Harvest_Time" name="Harvest_Time"  ><br/>
				<label>含量测定：</label>
				<input type="text" id="Pesticide_Remain" name="Pesticide_Remain"  ><br/>
				<label>质检报告：</label>
				<input type="text" id="Test_Report" name="Test_Report" ><br/>	
				<label>产地证明：</label>
				<input type="text" id="Origin_Certificate" name="Origin_Certificate" ><br/>
				<label>交易凭证：</label>
				<input type="text" id="Transaction_Voucher" name="Transaction_Voucher"  ><br/>
				<label>交易数量：</label>
				<input type="text" id="Deal_Quantity" name="Deal_Quantity"  ><br/>
				<label>交易时间：</label>
				<input type="text" id="Deal_Time" name="Deal_Time"  ><br/>
				<label>交易品种：</label>
				<input type="text" id="Deal_Variety" name="Deal_Variety" ><br/>
				<label>交易价格：</label>
				<input type="text" id="Deal_Price" name="Deal_Price" ><br/>
				<label>交易流向：</label>
				<input type="text" id="Counterparty" name="Counterparty"  ><br/><br/>
				<label>种植图片上传</label>
				...
				<a href="Planting_upload.jsp">批量上传</a>
				</center>
				<div class="clearfix"> </div>
			</div>
		</div>
