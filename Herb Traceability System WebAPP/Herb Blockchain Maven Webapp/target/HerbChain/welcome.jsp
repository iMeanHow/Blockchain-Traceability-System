			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="use_id.jsp">饮片使用</a></li>
						<li class="active"><a href="about_info.jsp"><span data-hover="About">关于我们</span></a></li>
					</ul>
				</nav>
...
<!-- //banner -->	
    <div id="exampleSlider">
        <div><h3>从生产到销售<span>基于HyperLedger的区块链全记录</span></h3></div>
        <div><h3>生产产地<span>基于HyperLedger的区块链全记录</span></h3></div>
        <div><h3>加工环节<span>基于HyperLedger的区块链全记录</span></h3></div>
		<div><h3>销售环节<span>基于HyperLedger的区块链全记录</span></h3></div>
    </div>
...
<div class="w3-about-us">
	<div class="container">
		...
		<ul>
		<center>
			<li><h3><span><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span><a href="planting_id.jsp">中药种植</a></h3></li>
			<li><h3><span><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span><a href="market_id.jps">药材市场</a></h3></li>
			<li><h3><span><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span><a href="drinks_Production_id.jsp">饮片生产</a></h3></li>
			<li><h3><span><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span><a href="business_id.jsp">饮片经营</a></h3></li>
			</center>
		</ul>
		</div>
		...
		<ul>
		<center>
			<li><h3><span><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span><a href="enterprise_id.jsp">药材企业</a></h3></li>
			<li><h3><span><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span><a href="market_id.jsp">药材市场</a></h3></li>
			<li><h3><span><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span><a href="use_id.jsp">饮片使用</a></h3></li>
			</center>
		</ul>
		</div>
		<div class="clearfix"></div>
...
<!-- services -->
	<div class="w3-agile-services">
		<div class="container">
			<div class="w3-headings-all">
				<h3>基于Hyperledger Fabric的区块链系统</h3>
			</div>
