	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>饮片使用信息插入</font></li>
...
<div class="skills w3-agileits w3-services-page">
		<div class="container"> 
			<div class="skills-agileinfo">
				...
				<center>
				<h4>请输入增添信息</h4>		
				<form action="use/insert.action" method="post" id="uploadForm">
				<label>ID：</label>
				<input type="text" id="ID" name="ID" ><br/>
				<label>公司：</label>
				<input type="text" id="Company" name="Company" readonly value=${myuse.company }><br/>
				<label>药店进货账目：</label>
				<input type="text" id="Pharmacy_Ledger" name="Pharmacy_Ledger" readonly value=${myuse.pharmacy_Ledger }><br/>
				<label>消费者交易凭证：</label>
				<input type="text" id="Consumer_Ledger" name="Consumer_Ledger" readonly value=${myuse.consumer_Ledger }><br/><br/>
				<label>图片上传</label>
