		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>   请输入查询ID</h4>
				<form action="business/search.action" method="post">
				...
				<form action="business/reset.action" method="post">
				<input type="submit" value="重置" />
				</form>
								
				<h3>市场图片展示</h3>
				<img src="${mybusiness.picture_url }" height="300" width="450"/><br/><br/>	
				<h3>企业图片展示</h3>
				<img src="${mybusiness.picture_url1 }" height="300" width="450"/><br/><br/><br/>
				</div>
				<h4>     药材市场信息</h4>
				<div class="col-md-6 skills-w3right bar_group"> 
				<label>品种：</label>
				<input type="text" id="Variety" name="Variety" readonly style="border:0px" value=${mybusiness.variety }><br/><br/>
				<label>产地：</label>
				<input type="text" id="Source" name="Source" readonly style="border:0px" value=${mybusiness.source }><br/><br/>
				<label>批号：</label>
				<input type="text" id="Storage_Batch" name="Storage_Batch" readonly style="border:0px" value=${mybusiness.storage_Batch }><br/><br/>
				<label>批量：</label>
