...
<script type="text/javascript">
	function UpladFile() {
		...
		var FileController = "${pageContext.request.contextPath}/market/UpImg.action"; // 接收上传文件的后台地址 
		// FormData 对象
	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>中药材专业市场信息修改</font></li>
		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>请输入查询ID</h4>
				<form action="market/usearch.action" method="post">
				...
				<input type="submit" value="查询" />
					...
					<h3>公司图片展示</h3>
				<img src="${mymarketu.picture_url }" alt="" id="pic" name="pic" height="300" width="450"><br/><br/> 
									<h3>产品图片展示</h3>
				<img src="${mymarketu.picture_url1 }" alt="" id="pic1" name="pic1" height="300" width="450"><br/><br/> 
				</div>
				<h4>中药材专业市场信息</h4>
				<div class="col-md-6 skills-w3right bar_group"> 
				<form action="market/insert.action" method="post" id="uploadForm">
				<input type="hidden" id="ID" name="ID"  value=${mymarketu.ID }>
				<label>公司：</label>
				<input type="text" id="Company" name="Company"  value=${mymarketu.company }><br/>
				<label>身份登记：</label>
				<input type="text" id="Business_License" name="Business_License"  value=${mymarketu.business_License }><br/>
				<label>追溯承诺书：</label>
				<input type="text" id="Traceability_Promise" name="Traceability_Promise"  value=${mymarketu.traceability_Promise }><br/>
				<label>批发商：</label>
				<input type="text" id="Wholesaler" name="Wholesaler"  value=${mymarketu.wholesaler }><br/>
				<label>种植品种：</label>
				<input type="text" id="Marketing_Variety" name="Marketing_Variety"  value=${mymarketu.marketing_Variety }><br/>
				<label>种植数量：</label>
				<input type="text" id="Marketing_Quantity" name="Marketing_Quantity"  value=${mymarketu.marketing_Quantity }><br/>
				<label>认证号码：</label>
				<input type="text" id="Origin_Certificate" name="Origin_Certificate"  value=${mymarketu.origin_Certificate }><br/>
				<label>种植企业或个人：</label>
				<input type="text" id="Enterprise" name="Enterprise"  value=${mymarketu.enterprise }><br/>
				<label>残留成分：</label>
				<input type="text" id="Pesticide_Remain" name="Pesticide_Remain"  value=${mymarketu.pesticide_Remain }><br/>
				<label>含量测定：</label>
				<input type="text" id="Content_Test" name="Content_Test"  value=${mymarketu.content_Test }><br/>
				<label>质检报告：</label>
				<input type="text" id="Test_Report" name="Test_Report"  value=${mymarketu.test_Report }><br/>
				<label>交易品种：</label>
				<input type="text" id="Dealing_Variety" name="Dealing_Variety"  value=${mymarketu.dealing_Variety }><br/>
				<label>交易价格：</label>
				<input type="text" id="Dealing_Price" name="Dealing_Price"  value=${mymarketu.dealing_Price }><br/>
				<label>交易数量：</label>
				<input type="text" id="Dealing_Quantity" name="Dealing_Quantity"  value=${mymarketu.dealing_Quantity }><br/>	
				<label>买主：</label>
				<input type="text" id="Dealing_Counterparty" name="Dealing_Counterparty"  value=${mymarketu.dealing_Counterparty }><br/>
				<label>流向：</label>
				<input type="text" id="Dealing_Flow" name="Dealing_Flow"  value=${mymarketu.dealing_Flow }><br/>
				公司图片上传（若已有图片则覆盖原图）
				...
				<input type="hidden" name="Picture_url" id="Picture_url" value=${mymarketu.picture_url }>
				<input type="hidden" name="Picture_url1" id="Picture_url1" value=${mymarketu.picture_url1 }>
				<br/>
...
<div class="footer-final">
		<div class="copyw3-agile"> 
			<div class="container">
				<p>&copy; 中药药材区块链溯源系统. All rights reserved | Design by NKU</p>
			</div>
		</div>
	</div>
