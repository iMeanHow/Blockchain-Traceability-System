...
<script type="text/javascript">
	function UpladFile() {
		...
		var FileController = "${pageContext.request.contextPath}/drinks_Production/UpImg.action"; // 接收上传文件的后台地址 
		// FormData 对象
	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>饮片生产信息修改</font></li>
		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>请输入查询ID</h4>
				<form action="drinks_Production/usearch.action" method="post">
				<input type="text" id="ID" name="ID" placeholder="请输入ID" value=${mydrinks_Productionu.ID }>
				<span>
				<input type="submit" value="查询" />
				</span>
				</form>
									<h3>公司图片展示</h3>
				<img src="${mydrinks_Productionu.picture_url }" alt="" id="pic" name="pic" height="300" width="450"><br/><br/> 
													<h3>库房图片展示</h3>
				<img src="${mydrinks_Productionu.picture_url1 }" alt="" id="pic1" name="pic1" height="300" width="450"><br/><br/> 
				</div>
				<h4>饮片生产信息</h4>
				<div class="col-md-6 skills-w3right bar_group"> 
				<form action="drinks_Production/insert.action" method="post" id="uploadForm">
				<input type="hidden" id="ID" name="ID"  value=${mydrinks_Productionu.ID }>
				<label>公司：</label>
				<input type="text" id="Company" name="Company"  value=${mydrinks_Productionu.company }><br/>
				<label>身份登记：</label>
				<input type="text" id="Business_License" name="Business_License"  value=${mydrinks_Productionu.business_License }><br/>
				<label>追溯承诺书：</label>
				<input type="text" id="Traceability_Promise" name="Traceability_Promise"  value=${mydrinks_Productionu.traceability_Promise }><br/>
				<label>GMP证书：</label>
				<input type="text" id="GMP_Certificate" name="GMP_Certificate"  value=${mydrinks_Productionu.GMP_Certificate }><br/>
				<label>不合格解除交易：</label>
				<input type="text" id="Auto_Cancelation" name="Auto_Cancelation"  value=${mydrinks_Productionu.auto_Cancelation }><br/>
				<label>检测报告：</label>
				<input type="text" id="Test_Report" name="Test_Report"  value=${mydrinks_Productionu.test_Report }><br/>
				<label>药材品种：</label>
				<input type="text" id="Variety" name="Variety"  value=${mydrinks_Productionu.variety }><br/>
				<label>入库时间：</label>
				<input type="text" id="Storage_Time" name="Storage_Time"  value=${mydrinks_Productionu.storage_Time }><br/>
				<label>入库批次：</label>
				<input type="text" id="Storage_Batch" name="Storage_Batch"  value=${mydrinks_Productionu.storage_Batch }><br/>	
				<label>入库数量：</label>
				<input type="text" id="Storage_Quantity" name="Storage_Quantity"  value=${mydrinks_Productionu.storage_Quantity }><br/>	
				<label>入库等级：</label>
				<input type="text" id="Classification" name="Classification"  value=${mydrinks_Productionu.classification }><br/>	
				<label>药材来源：</label>
				<input type="text" id="Source" name="Source"  value=${mydrinks_Productionu.source }><br/>	
				<label>库房温度：</label>
				<input type="text" id="Storage_Temp" name="Storage_Temp"  value=${mydrinks_Productionu.storage_Temp }><br/>	
				<label>库房湿度：</label>
				<input type="text" id="Storage_Humidity" name="Storage_Humidity"  value=${mydrinks_Productionu.storage_Humidity }><br/>	
				<label>加工方法：</label>
				<input type="text" id="Process_Method" name="Process_Method"  value=${mydrinks_Productionu.process_Method }><br/>	
				<label>包装批次：</label>
				<input type="text" id="Packing_Batch" name="Packing_Batch"  value=${mydrinks_Productionu.packing_Batch }><br/>
				<label>包装等级：</label>
				<input type="text" id="Packing_Class" name="Packing_Class"  value=${mydrinks_Productionu.packing_Class }><br/>	
				<label>包装批量：</label>
				<input type="text" id="Packing_Quantity" name="Packing_Quantity"  value=${mydrinks_Productionu.packing_Quantity }><br/>	
				<label>交易信息记录：</label>
				<input type="text" id="Deal_Info" name="Deal_Info"  value=${mydrinks_Productionu.deal_Info }><br/>	
				<label>出库品种：</label>
				<input type="text" id="Output_Variety" name="Output_Variety"  value=${mydrinks_Productionu.output_Variety }><br/>	
				<label>出库时间：</label>
				<input type="text" id="Output_Time" name="Output_Time"  value=${mydrinks_Productionu.output_Time }><br/>	
				<label>出库批次：</label>
				<input type="text" id="Output_Batch" name="Output_Batch"  value=${mydrinks_Productionu.output_Batch }><br/>	
				<label>出库数量：</label>
				<input type="text" id="Output_Quantity" name="Output_Quantity"  value=${mydrinks_Productionu.output_Quantity }><br/>
				<label>出库去向：</label>
				<input type="text" id="Output_Flow" name="Output_Flow"  value=${mydrinks_Productionu.output_Flow }><br/>	
				<label>库房温度：</label>
				<input type="text" id="Output_Temp" name="Output_Temp"  value=${mydrinks_Productionu.output_Temp }><br/>	
				<label>库房湿度：</label>
				<input type="text" id="Output_Humidity" name="Output_Humidity"  value=${mydrinks_Productionu.output_Humidity }><br/>
				公司图片上传（若已有图片则覆盖原图）
				...
				<input type="hidden" name="Picture_url" id="Picture_url" value=${mydrinks_Productionu.picture_url }>
				<br/>
