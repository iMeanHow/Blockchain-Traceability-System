	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>质检报告信息批量插入</font></li>
...
<div class="skills w3-agileits w3-services-page">
		<div class="container"> 
			<div class="skills-agileinfo">
				...
				<center>
					<h4>请输入增添信息</h4>		
				<form action="test_Report/insert.action" id="uploadForm" method="post">
				...
				<label>生产地点：</label>
				<input type="text" id="Production_Place" name="Production_Place" ><br/>
				<label>生产数量：</label>
				<input type="text" id="Quantity" name="Quantity" ><br/>
				<label>生产批次：</label>
				<input type="text" id="Batch" name="Batch" ><br/>
				<label>样本来源：</label>
				<input type="text" id="Sample_Origin" name="Sample_Origin" ><br/>
				<label>测试种类：</label>
				<input type="text" id="Test_Type" name="Test_Type" ><br/>
				<label>测试时间：</label>
				<input type="text" id="Test_Date" name="Test_Date" ><br/>	
				<label>报告时间：</label>
				<input type="text" id="Report_Date" name="Report_Date" ><br/>
				<label>报告参考：</label>
				<input type="text" id="Reference" name="Reference" ><br/>
				<label>样本性质：</label>
				<input type="text" id="Characteristics" name="Characteristics" ><br/>
				<label>样本微观性质：</label>
				<input type="text" id="Micro_Character" name="Micro_Character" ><br/>
				<label>样本薄性质：</label>
				<input type="text" id="Thin_Layer_Character" name="Thin_Layer_Character" ><br/>
				<label>湿度：</label>
				<input type="text" id="Moisture" name="Moisture" ><br/>
				<label>含灰量：</label>
				<input type="text" id="Ashes" name="Ashes" ><br/>
				<label>不溶酸含灰量：</label>
				<input type="text" id="Acid_Insoluble_Ash" name="Acid_Insoluble_Ash" ><br/>
				<label>SO2残留：</label>
				<input type="text" id="SO2_Remain" name="SO2_Remain" ><br/>
				<label>粒度：</label>
				<input type="text" id="Granularity" name="Granularity" ><br/>
				<label>均匀度：</label>
				<input type="text" id="Evenness" name="Evenness" ><br/>
				<label>细菌含量：</label>
				<input type="text" id="Microbe_Limitation" name="Microbe_Limitation" ><br/>
				<label>萃取成分：</label>
				<input type="text" id="Extractive" name="Extractive" ><br/>
				<label>鉴定结论：</label>
				<input type="text" id="Conclusion" name="Conclusion" ><br/><br/>
				<label>药材图片上传</label>
				...
				<a href="Test_Report_upload.jsp">批量上传</a>
				</center>
				<div class="clearfix"> </div>
			</div>
		</div>
