	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>药材市场信息插入</font></li>
...
<div class="skills w3-agileits w3-services-page">
		<div class="container"> 
			<div class="skills-agileinfo">
				...
				<center>
					<h4>请输入增添信息</h4>		
				<form action="business/insert.action" id="uploadForm" method="post">
				...
				<label>生产企业：</label>
				<input type="text" id="Product_Enterprise" name="Product_Enterprise" ><br/>
				<label>生产时间：</label>
				<input type="text" id="Produce_Time" name="Produce_Time"><br/>
				<label>流通节点：</label>
				<input type="text" id="Flow_Nodes" name="Flow_Nodes" ><br/>
				<label>交易信息：</label>
				<input type="text" id="Deal_Info" name="Deal_Info"><br/>	
				<label>身份登记：</label>
				<input type="text" id="Business_License" name="Business_License"><br/>
				<label>GSP许可：</label>
				<input type="text" id="GSP_Permission" name="GSP_Permission"><br/>
				<label>环境温湿度：</label>
				<input type="text" id="Humidity" name="Humidity"><br/>
				<label>追溯承诺书：</label>
				<input type="text" id="Traceability_Promise" name="Traceability_Promise"><br/><br/>
				<label>市场图片上传</label>
				...
				<a href="Business_upload.jsp">批量上传</a>
				</center>
				<div class="clearfix"> </div>
			</div>
		</div>
