...
<script type="text/javascript">
	function UpladFile() {
		...
		var FileController = "${pageContext.request.contextPath}/test_Report/UpImg.action"; // 接收上传文件的后台地址 
		// FormData 对象
		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>请输入查询ID</h4>
				<form action="test_Report/usearch.action" method="post">
				<input type="text" id="ID" name="ID" placeholder="请输入ID" value=${mytest_Reportu.ID }>
				<span>
				<input type="submit" value="查询" />
				</span>
				</form>			
				<h3>药材图片展示</h3>
				<img src="${mytest_Reportu.picture_url }" alt="" id="pic" name="pic" height="300" width="450"><br/><br/> 
				<h3>质检图片展示</h3>
				<img src="${mytest_Reportu.picture_url1 }" alt="" id="pic1" name="pic1" height="300" width="450"><br/><br/> 
				</div>
				<h4>药材市场信息</h4>
				<div class="col-md-6 skills-w3right bar_group"> 
				<form action="test_Report/insert.action" method="post" id="uploadForm">
				<input type="hidden" id="ID" name="ID"  value=${mytest_Reportu.ID }>
				<label>报告ID：</label>
				<input type="text" id="Report_ID" name="Report_ID"  value=${mytest_Reportu.report_ID }><br/>
				<label>产品名称：</label>
				<input type="text" id="Product_Name" name="Product_Name"  value=${mytest_Reportu.product_Name }><br/>
				<label>产品特点：</label>
				<input type="text" id="Specification" name="Specification"  value=${mytest_Reportu.specification }><br/>
				<label>生产地点：</label>
				<input type="text" id="Production_Place" name="Production_Place"  value=${mytest_Reportu.production_Place }><br/>
				<label>生产数量：</label>
				<input type="text" id="Quantity" name="Quantity"  value=${mytest_Reportu.quantity }><br/>
				<label>生产批次：</label>
				<input type="text" id="Batch" name="Batch"  value=${mytest_Reportu.batch }><br/>
				<label>样本来源：</label>
				<input type="text" id="Sample_Origin" name="Sample_Origin"  value=${mytest_Reportu.sample_Origin }><br/>
				<label>测试种类：</label>
				<input type="text" id="Test_Type" name="Test_Type"  value=${mytest_Reportu.test_Type }><br/>
				<label>测试时间：</label>
				<input type="text" id="Test_Date" name="Test_Date"  value=${mytest_Reportu.test_Date }><br/>	
				<label>报告时间：</label>
				<input type="text" id="Report_Date" name="Report_Date"  value=${mytest_Reportu.report_Date }><br/>
				<label>报告参考：</label>
				<input type="text" id="Reference" name="Reference"  value=${mytest_Reportu.reference }><br/>
				<label>样本性质：</label>
				<input type="text" id="Characteristics" name="Characteristics"  value=${mytest_Reportu.characteristics }><br/>
				<label>样本微观性质：</label>
				<input type="text" id="Micro_Character" name="Micro_Character"  value=${mytest_Reportu.micro_Character }><br/>
				<label>样本薄性质：</label>
				<input type="text" id="Thin_Layer_Character" name="Thin_Layer_Character"  value=${mytest_Reportu.thin_Layer_Character }><br/>
				<label>湿度：</label>
				<input type="text" id="Moisture" name="Moisture"  value=${mytest_Reportu.moisture }><br/>
				<label>含灰量：</label>
				<input type="text" id="Ashes" name="Ashes"  value=${mytest_Reportu.ashes }><br/>
				<label>不溶酸含灰量：</label>
				<input type="text" id="Acid_Insoluble_Ash" name="Acid_Insoluble_Ash"  value=${mytest_Reportu.acid_Insoluble_Ash }><br/>
				<label>SO2残留：</label>
				<input type="text" id="SO2_Remain" name="SO2_Remain"  value=${mytest_Reportu.sO2_Remain }><br/>
				<label>粒度：</label>
				<input type="text" id="Granularity" name="Granularity"  value=${mytest_Reportu.granularity }><br/>
				<label>均匀度：</label>
				<input type="text" id="Evenness" name="Evenness" value=${mytest_Reportu.evenness }><br/>
				<label>细菌含量：</label>
				<input type="text" id="Microbe_Limitation" name="Microbe_Limitation"  value=${mytest_Reportu.microbe_Limitation }><br/>
				<label>萃取成分：</label>
				<input type="text" id="Extractive" name="Extractive"  value=${mytest_Reportu.extractive }><br/>
				<label>鉴定结论：</label>
				<input type="text" id="Conclusion" name="Conclusion"  value=${mytest_Reportu.conclusion }><br/>
				药材图片上传（若已有图片则覆盖原图）
				...
				<input type="hidden" name="Picture_url" id="Picture_url" value=${mytest_Reportu.picture_url }>
				<input type="hidden" name="Picture_url1" id="Picture_url1" value=${mytest_Reportu.picture_url1 }>
				<br/>
