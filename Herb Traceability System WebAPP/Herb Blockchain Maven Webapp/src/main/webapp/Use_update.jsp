...
<script type="text/javascript">
	function UpladFile() {
		...
		var FileController = "${pageContext.request.contextPath}/use/UpImg.action"; // 接收上传文件的后台地址 
		// FormData 对象
	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>饮片使用信息修改</font></li>
		...
		<div class="container"> 
			<div class="skills-agileinfo">
				<div class="col-md-6 skills-w3left">
					<h4>请输入查询ID</h4>
				<form action="use/usearch.action" method="post">
				<input type="text" id="ID" name="ID" placeholder="请输入ID" value=${myuseu.ID }>
				<span>
				<input type="submit" value="查询" />
				</span>
				</form>
									<h3>图片展示</h3>
				<img src="${myuseu.picture_url }" alt="" id="pic" name="pic" height="300" width="450"><br/><br/> 
				</div>
				<h4>饮片使用信息</h4>
				<div class="col-md-6 skills-w3right bar_group"> 
				<form action="use/update.action" method="post" id="uploadForm">
				<input type="hidden" id="ID" name="ID"  value=${myuseu.ID }>
				<label>公司：</label>
				<input type="text" id="Company" name="Company"  value=${myuseu.company }><br/>
				<label>药店进货账目：</label>
				<input type="text" id="Pharmacy_Ledger" name="Pharmacy_Ledger"  value=${myuseu.pharmacy_Ledger }><br/>
				<label>消费者交易凭证：</label>
				<input type="text" id="Consumer_Ledger" name="Consumer_Ledger"  value=${myuseu.consumer_Ledger }><br/>
				图片上传（若已有图片则覆盖原图）
				...
				<input type="hidden" name="Picture_url" id="Picture_url" value=${myuseu.picture_url }>
				<br/>
