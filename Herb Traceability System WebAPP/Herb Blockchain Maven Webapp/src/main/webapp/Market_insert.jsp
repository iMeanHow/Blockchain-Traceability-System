	...
	<div class="about-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><font size=6>中药材专业市场信息插入</font></li>
...
<div class="skills w3-agileits w3-services-page">
		<div class="container"> 
			<div class="skills-agileinfo">
				...
				<label>批发商：</label>
				<input type="text" id="Wholesaler" name="Wholesaler" ><br/>
				<label>种植品种：</label>
				<input type="text" id="Marketing_Variety" name="Marketing_Variety" ><br/>
				<label>种植数量：</label>
				<input type="text" id="Marketing_Quantity" name="Marketing_Quantity" ><br/>
				<label>认证号码：</label>
				<input type="text" id="Origin_Certificate" name="Origin_Certificate"><br/>
				<label>种植企业或个人：</label>
				<input type="text" id="Enterprise" name="Enterprise" ><br/>
				<label>残留成分：</label>
				<input type="text" id="Pesticide_Remain" name="Pesticide_Remain"><br/>
				<label>含量测定：</label>
				<input type="text" id="Content_Test" name="Content_Test" ><br/>
				<label>质检报告：</label>
				<input type="text" id="Test_Report" name="Test_Report" ><br/>
				<label>交易品种：</label>
				<input type="text" id="Dealing_Variety" name="Dealing_Variety"><br/>
				<label>交易价格：</label>
				<input type="text" id="Dealing_Price" name="Dealing_Price" ><br/>
				<label>交易数量：</label>
				<input type="text" id="Dealing_Quantity" name="Dealing_Quantity"><br/>	
				<label>买主：</label>
				<input type="text" id="Dealing_Counterparty" name="Dealing_Counterparty"><br/>
				<label>流向：</label>
				<input type="text" id="Dealing_Flow" name="Dealing_Flow"><br/><br/>
				<label>公司图片上传</label>
				...
				<a href="Market_upload.jsp">批量上传</a>
				</center>
				<div class="clearfix"> </div>
			</div>
		</div>
